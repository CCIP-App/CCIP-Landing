...
export default {
    get iTunesAppId() { return appManifest.related_applications == undefined ? document.querySelector('meta[name="apple-itunes-app"]').content.split('=').pop() : appManifest.related_applications[0].id; },
